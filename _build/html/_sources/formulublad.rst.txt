...
.. math::
    \begin{aligned}
        ...
        \bar{a} + \bar{b} &= \begin{pmatrix}a_x+b_x \\ a_y+b_y \\ a_z+b_z \end{pmatrix} \\
        c \cdot \bar{v} &= \begin{pmatrix}c \cdot v_x\\ c \cdot v_y \\ c \cdot v_z \end{pmatrix} \\
...
.. math::
    \begin{aligned}
        ...
        &= \lim_{h \to 0} \frac{x_{t+h}-x_{t}}{(t+h) - t} = \lim_{h\to 0}\frac{x_{t+h}-x_{t}}{h} = \frac{dx}{dt} \\
    \end{aligned}
...
.. math::
    \begin{aligned}
        ...
        &= \lim_{h \to 0} \frac{v_{t+h}-v_{t}}{(t+h) - t} = \lim_{h\to 0}\frac{v_{t+h}-v_{t}}{h} = \frac{dv}{dt} \\
    \end{aligned}
